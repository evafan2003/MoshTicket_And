...
public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup arg2) {
            ...
            if (holder == null) {
                ...
                if (view == null) {
                    view = inflater.inflate(R.layout.list_ticketnames, null);
                }
                holder.cb = (CheckBox) view.findViewById(R.id.checkb);
                holder.tv = (TextView) view.findViewById(R.id.ticketname);
            ...
            if (map != null) {
                ...
                holder.ticketid.setText((String) map.get(keyString[2]));
